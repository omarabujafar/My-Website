...
export default function Orb({ hue = 0, hoverIntensity = 0.2, rotateOnHover = true, forceHoverState = false }) {
  ...
  const frag = /* glsl */ `
    ...
    vec4 mainImage(vec2 fragCoord) {
      ...
      // Store original UV (no hover distortion applied)
      originalUv = uv;

      // Hover distortion disabled
  ...
  useEffect(() => {
    ...
    img.onload = () => {
      ...
      program.uniforms.uTextureAspect.value = aspect;
      program.uniforms.uTextureLoaded.value = 1;
    };
    img.src = heroPhoto;
